...
<%--            <a style="margin-top: 5px;" href="javascript:history.back()" ><i class="layui-icon layui-icon-next" style="color: #666;"></i><cite>学校院系设置</cite></a>--%>
            ...
            <button style="float: right;" class="layui-btn layui-btn-primary" onclick="deleleAcademic()">添加文件夹</button>
		    <button style="float: right;" class="layui-btn layui-btn-primary" onclick="getiframe('getaddAcademic.do')">上传文件</button>
		...
		<table class="layui-table" style="width: 1050px;" lay-skin="line">
		             <tr>
                        ...
                        <td width="12%" height="20" align="center">操作</td>
                    </tr>
             </thead>
                        ...
                        <c:choose>
                            <c:when test="${file.isDir==0}">
                                ...
                                <td height="20" align="center">
                                    <button class="layui-btn" onclick="download('${file.fileName}')">下载</button>
                                    <button class="layui-btn" onclick="download('${file.fileName}')">删除</button>
                                    <button class="layui-btn" onclick="download('${file.fileName}')">分享</button>
                                </td>
                            </c:when>
